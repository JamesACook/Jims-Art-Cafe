...
By clicking on the index file the website should run automatically on a browser with GitHub hosting. Alternatively all the files in the Art Cafe folder can be downloaded and run locally in the same fashion by opening the index file in a browser such as Edge.
